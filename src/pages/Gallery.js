...
render(){
    return(
        ...
        <div className="container">
            ...
            {/* <input type="text" className="form-control my-2" placeholder="Cari Buku Favoritemu Disini!"
                value={this.state.keyword}
                onChange={ev => this.setState({keyword: ev.target.value})}
                onKeyUp={ev => this.searching(ev)}
                 /> */}
            ...
            <button className="btn btn-primary mt-3 mb-5 " onClick={() => this.Add()}>
                Tambah Data
            </button>

            {/* component modal sbg control manipulasi data */}
            {/* <div data-toggle="modal" data-target="#modal_buku"></div> */}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={ev => this.Save(ev)}>
                                ...
                                {/* <button className="btn btn-danger btn-block m-2" type="submit">
                                    Tutup
                                </button> */}
                            </form>
                        </div>
